...
if __name__ == "__main__":
    train_pong = pong.Pong(None, 200000)
    train_data = train_pong.main()
    del train_pong

    model = ann.NeuralNetwork(input_size=4, output_size=cfg.HEIGHT, hidden_layers=[200, 200, 200], learning_rate=0.01)
    model.summary()
    model.train_model(train_data, epochs=20)
